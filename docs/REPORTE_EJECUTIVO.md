...
- 🔜 **E4 — Taller Paramétrico** (primer tramo, brief: `docs/fases/FASE_E4_TALLER.md`). Constructores de nombres, cajas y llaveros con bandeja temporal, sobre el backend de Cubo Manager y la Biblioteca ya existentes.
